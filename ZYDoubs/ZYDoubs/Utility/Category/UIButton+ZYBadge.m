...
#import "UIButton+ZYBadge.h"
#import <objc/runtime.h>

//button 的badge隐藏数字
#define BadgeHiddenStr @"123456"
...
@implementation UIButton(ZYBadge)
...
- (void)badgeInit
{
    ...
    self.badgePadding   = 2;
    self.badgeMinSize   = 8;
    self.badgeOriginX   = self.frame.size.width - 40 ;
    self.badgeOriginY   = 5;
...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    //    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:BadgeHiddenStr] && self.shouldHideBadgeAtZero)) {
    
    if (!badgeValue || ([badgeValue isEqualToString:BadgeHiddenStr] && self.shouldHideBadgeAtZero)) {
        [self removeBadge];
    } else if (!self.badge) {
