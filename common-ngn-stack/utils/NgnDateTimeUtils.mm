...
+(NSDateFormatter*) chatYear{
    static NSDateFormatter* sChatDate = nil;
    if(!sChatDate){
        sChatDate = [[NSDateFormatter alloc] init];
        [sChatDate setDateFormat:@"yyyy"];
    }
    return sChatDate;
}

+(NSDateFormatter*) chatMonth{
    static NSDateFormatter* sChatDate = nil;
    if(!sChatDate){
        sChatDate = [[NSDateFormatter alloc] init];
        [sChatDate setDateFormat:@"MM"];
    }
    return sChatDate;
}

+(NSDateFormatter*) chatDay{
    static NSDateFormatter* sChatDate = nil;
    if(!sChatDate){
        sChatDate = [[NSDateFormatter alloc] init];
        [sChatDate setDateFormat:@"dd"];
    }
    return sChatDate;
}
